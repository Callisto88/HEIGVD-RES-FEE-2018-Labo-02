    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV2Protocol.CMD_CLEAR:
          /* Efface les étudients stockés dans le serveur, puis envoie que cela a été effectué */
          store.clear();
          writer.println(RouletteV2Protocol.RESPONSE_CLEAR_DONE);
          writer.flush();
          break;
        case RouletteV2Protocol.CMD_LIST:
          /* On set la liste d'étudient récupérer depuis le serveur puis on le parse en Json*/
